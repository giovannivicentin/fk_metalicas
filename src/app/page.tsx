...
export default function Home() {
  return (
    <div className="min-h-screen py-8 flex flex-col items-center bg-background-color">
      <div className="bg-apresentation bg-cover bg-center w-5/6 sm:w-3/4 min-h-96 sm:min-h-[26rem] xl:min-h-[30rem] rounded-xl flex flex-col justify-end px-6 sm:px-14 p-10 sm:py-8">
