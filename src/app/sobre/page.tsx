...
function AboutPage() {
  return (
    <div className="flex flex-col gap-4 items-center pt-[4.5rem] pb-8 bg-background-color">
      <div className="flex flex-col-reverse items-center justify-between lg:flex-row w-11/12 lg:w-3/4 gap-4 mt-4 lg:mt-20">
        <Image
          loading="lazy"
          src="/perfil.png"
          alt="perfil image"
          width="371"
          height="453"
          className="rounded-xl mt-4 lg:mt-0 animate-fade-right animate-once delay-500"
        ></Image>
        <div className="animate-fade-left animate-once delay-300">
          <h2 className="text-center leading-relaxed text-2xl font-extrabold">
            Sobre nós
          </h2>
          <p className="leading-relaxed text-justify text-sm lg:text-lg lg:text-justify mt-4 lg:px-8">
